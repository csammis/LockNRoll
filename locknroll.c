    ...
    case WM_WTSSESSION_CHANGE:
        ...
        case WTS_SESSION_LOCK:
            ...
            for(; iter != NULL; iter = iter->next)
            {
                ...
                {
                    status_type = purple_account_get_status_type_with_primitive(acct, PURPLE_STATUS_AWAY);
                    if(status_type != NULL)
                    {
...
static PurplePluginInfo info =
{
    ...
    "1.0.1",
    "Away on lock",
    "Sets account statuses to Away on workstation lock",
    "Chris Sammis (csammis@gmail.com)",
    "http://csammisrun.net/blog/category/locknroll/",
    plugin_load,
    plugin_unload,
    NULL,
    NULL,
